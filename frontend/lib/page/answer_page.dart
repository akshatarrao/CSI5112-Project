...
class AnswerPage extends StatefulWidget {
  ...
  const AnswerPage(this.questionID, this.currentUser, {Key? key})
      : super(key: key);
...
class _AnswerPageState extends State<AnswerPage> {
    ...
    return MaterialApp(
        home: Scaffold(
            ...
            body: FutureBuilder(
                          ...
                          return Padding(
                              ...
                              child: Card(
                                child: GFListTile(
                                  ...
                                  subTitle: Text(
                                      questions[widget.questionID].description,
                ...
                future: Future.wait([futureQuestions, futureAnswers]))));
  }
  ...
  void postAnswer(String aDescription) {
    ...
    var request =
        Request('POST', Uri.parse('https://localhost:7156/api/answer'));
  ...
  Future<List<Question>> getQuestions() async {
    final response =
        await get(Uri.parse('https://localhost:7156/api/question'));
